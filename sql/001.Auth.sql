CREATE SCHEMA IF NOT EXISTS auth AUTHORIZATION water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON account_types TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON profile_data_type TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON profile TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON permissions TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON object TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON user_permission TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON sessions TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON auth.account_associations TO water_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON auth.on_behalf_permissions TO water_user;
